...
<img src="../figures/tioga/Tioga-Mod3-Ex1a.png" width="550"/>
...
<img src="../figures/tioga/Tioga-Mod3-Ex1b.png" width="550"/>
</details>
...
gpu-st-g4dnmetal-1 Task   0/  8 running on 6 CPUs: 0-5
           Task   0/  8 has 4 GPUs: 0000:18 0000:19 0000:35 0000:36 
gpu-st-g4dnmetal-1 Task   1/  8 running on 6 CPUs: 6-11
           Task   1/  8 has 4 GPUs: 0000:18 0000:19 0000:35 0000:36 
gpu-st-g4dnmetal-1 Task   2/  8 running on 6 CPUs: 12-17
           Task   2/  8 has 4 GPUs: 0000:18 0000:19 0000:35 0000:36 
gpu-st-g4dnmetal-1 Task   3/  8 running on 6 CPUs: 18-23
           Task   3/  8 has 4 GPUs: 0000:18 0000:19 0000:35 0000:36 
gpu-st-g4dnmetal-1 Task   4/  8 running on 6 CPUs: 24-29
           Task   4/  8 has 4 GPUs: 0000:e7 0000:e8 0000:f4 0000:f5 
gpu-st-g4dnmetal-1 Task   5/  8 running on 6 CPUs: 30-35
           Task   5/  8 has 4 GPUs: 0000:e7 0000:e8 0000:f4 0000:f5 
gpu-st-g4dnmetal-1 Task   6/  8 running on 6 CPUs: 36-41
           Task   6/  8 has 4 GPUs: 0000:e7 0000:e8 0000:f4 0000:f5 
gpu-st-g4dnmetal-1 Task   7/  8 running on 6 CPUs: 42-47
           Task   7/  8 has 4 GPUs: 0000:e7 0000:e8 0000:f4 0000:f5 
```
</details>
...
```
gpu-st-g4dnmetal-2 Task   0/  8 running on 6 CPUs: 0-5
           Task   0/  8 has 1 GPUs: 0000:18 
gpu-st-g4dnmetal-2 Task   1/  8 running on 6 CPUs: 6-11
           Task   1/  8 has 1 GPUs: 0000:19 
gpu-st-g4dnmetal-2 Task   2/  8 running on 6 CPUs: 12-17
           Task   2/  8 has 1 GPUs: 0000:35 
gpu-st-g4dnmetal-2 Task   3/  8 running on 6 CPUs: 18-23
           Task   3/  8 has 1 GPUs: 0000:36 
gpu-st-g4dnmetal-2 Task   4/  8 running on 6 CPUs: 24-29
           Task   4/  8 has 1 GPUs: 0000:e7 
gpu-st-g4dnmetal-2 Task   5/  8 running on 6 CPUs: 30-35
           Task   5/  8 has 1 GPUs: 0000:e8 
gpu-st-g4dnmetal-2 Task   6/  8 running on 6 CPUs: 36-41
           Task   6/  8 has 1 GPUs: 0000:f4 
gpu-st-g4dnmetal-2 Task   7/  8 running on 6 CPUs: 42-47
           Task   7/  8 has 1 GPUs: 0000:f5 
```
</details>
...
```
gpu-st-g4dnmetal-2 Task   0/  4 running on 12 CPUs: 0-11
           Task   0/  4 has 1 GPUs: 0000:18 
gpu-st-g4dnmetal-2 Task   1/  4 running on 12 CPUs: 12-23
           Task   1/  4 has 1 GPUs: 0000:19 
gpu-st-g4dnmetal-2 Task   2/  4 running on 12 CPUs: 24-35
           Task   2/  4 has 1 GPUs: 0000:e7 
gpu-st-g4dnmetal-2 Task   3/  4 running on 12 CPUs: 36-47
           Task   3/  4 has 1 GPUs: 0000:e8 
```
</details>
...
<img src="../figures/tioga/Tioga-Mod3-Ex2a.png" width="550"/>
...
<img src="../figures/tioga/Tioga-Mod3-Ex2b.png" width="550"/>
</details>
...
gpu-st-g4dnmetal-1 Task   0/  2 running on 6 CPUs: 0-5
           Task   0/  2 has 2 GPUs: 0000:18 0000:19 
gpu-st-g4dnmetal-1 Task   1/  2 running on 6 CPUs: 24-29
           Task   1/  2 has 2 GPUs: 0000:e7 0000:e8 
```
</details>
...
<img src="../figures/tioga/Tioga-Mod3-Ex3a.png" width="550"/>
</details>
...
<img src="../figures/tioga/Tioga-Mod3-Ex3b.png" width="550"/>
</details>
...
```
[username2@ip-10-0-0-247 ~]$ srun --gpus-per-node=8 -n2 -c6 --cpu-bind=thread --gpu-bind=map_gpu:0,4 mpi+gpu
gpu-st-g4dnmetal-1 Task   1/  2 running on 6 CPUs: 24-29
           Task   1/  2 has 1 GPUs: 0000:e7
gpu-st-g4dnmetal-1 Task   0/  2 running on 6 CPUs: 0-5
           Task   0/  2 has 1 GPUs: 0000:18
```
...
<img src="../figures/tioga/Tioga-Mod3-Ex5a.png" width="550"/>
</details>
...
<img src="../figures/tioga/Tioga-Mod3-Ex5b.png" width="550"/>
</details>
...
```
gpu-st-g4dnmetal-2 Task   0/  4 running on 6 CPUs: 0-5
           Task   0/  4 has 4 GPUs: 0000:f5 0000:f4 0000:e8 0000:e7 
gpu-st-g4dnmetal-2 Task   1/  4 running on 6 CPUs: 6-11
           Task   1/  4 has 4 GPUs: 0000:f5 0000:f4 0000:e8 0000:e7 
gpu-st-g4dnmetal-2 Task   2/  4 running on 6 CPUs: 24-29
           Task   2/  4 has 4 GPUs: 0000:f5 0000:f4 0000:e8 0000:e7 
gpu-st-g4dnmetal-2 Task   3/  4 running on 6 CPUs: 30-35
           Task   3/  4 has 4 GPUs: 0000:f5 0000:f4 0000:e8 0000:e7
```
</details>
...
CUDA_VISIBLE_DEVICES takes precedence once again over Slurm's affinity controls. 
-->
...
gpu-st-g4dnmetal-2 Task   0/  2 running on 6 CPUs: 0-5
           Task   0/  2 has 2 GPUs: 0000:18 0000:e7 
gpu-st-g4dnmetal-2 Task   1/  2 running on 6 CPUs: 24-29
           Task   1/  2 has 2 GPUs: 0000:18 0000:e7 
```

We are using two GPUs in our parallel program -- one from each NUMA domain -- but each task has access to both GPUs. In exercise A, in contrast, each task had its own GPU.
...
<img src="../figures/tioga/Tioga-Mod3-Ex6.png" width="550"/>
</details>
...
```
[username2@ip-10-0-0-247 ~]$ srun -n4 -c8 --cpu-bind=thread assign_gpus mpi+gpu
gpu-st-g4dnmetal-1 Task   0/  4 running on 8 CPUs: 0-7
           Task   0/  4 has 1 GPUs: 0000:18
gpu-st-g4dnmetal-1 Task   1/  4 running on 8 CPUs: 8-15
           Task   1/  4 has 1 GPUs: 0000:19
gpu-st-g4dnmetal-1 Task   2/  4 running on 8 CPUs: 24-31
           Task   2/  4 has 1 GPUs: 0000:e7
gpu-st-g4dnmetal-1 Task   3/  4 running on 8 CPUs: 32-39
           Task   3/  4 has 1 GPUs: 0000:e8
```
...
```
[username2@ip-10-0-0-247 ~]$ srun -n2 -c6 --cpu-bind=thread assign_gpus mpi+gpu
gpu-st-g4dnmetal-1 Task   1/  2 running on 6 CPUs: 24-29
           Task   1/  2 has 1 GPUs: 0000:e7
gpu-st-g4dnmetal-1 Task   0/  2 running on 6 CPUs: 0-5
           Task   0/  2 has 1 GPUs: 0000:18
...
2. Using Slurm's GPU affinity or vendor-specific environment variables, run a 6-task MPI program such that 4 tasks reside on the first socket and use local GPUs (one GPU per task) and 2 tasks reside on the second socket and use local GPUs (two GPU per task). If using environment variables to control GPU affinity, you can still use Slurm to control CPU affinity. 
   ...
   * You'll have to handpick CPUs & GPUs for this one, so there's more than one correct answer!
   ...
   Similarly, the masks for the individual GPUs[4-7] can be constructed: 
...
Our GPU affinity will be specified by `-gpu-bind=mask_gpu:0x01,0x02,0x04,0x08,0x30,0xC0`.

As for CPU affinity, the current wording of the question is ambiguous as to how many CPUs/cores should be assigned to the tasks on each NUMA.

One reasonable interpretation is to assign one CPU per task:
...
Another interpretation might be to spread all of the first four tasks across NUMA 0 and the last two tasks across NUMA 1:

```
[username2@ip-10-0-0-247 ~]$ srun -t1 hwloc-calc --taskset --physical-output NUMAnode:0
0xffffff000000ffffff
[username2@ip-10-0-0-247 ~]$ srun -t1 hwloc-calc --taskset --physical-output NUMAnode:1
0xffffff000000ffffff000000
[username2@ip-10-0-0-247 ~]$ srun --gpus-per-node=8 -n6 --cpu-bind=mask_cpu:0xffffff000000ffffff,0xffffff000000ffffff,0xffffff000000ffffff,0xffffff000000ffffff,0xffffff000000ffffff000000,0xffffff000000ffffff000000 --gpu-bind=mask_gpu:0x01,0x02,0x04,0x08,0x30,0xC0 mpi+gpu
gpu-st-g4dnmetal-1 Task   5/  6 running on 48 CPUs: 24-47,72-95
           Task   5/  6 has 2 GPUs: 0000:f4 0000:f5
gpu-st-g4dnmetal-1 Task   4/  6 running on 48 CPUs: 24-47,72-95
           Task   4/  6 has 2 GPUs: 0000:e7 0000:e8
gpu-st-g4dnmetal-1 Task   0/  6 running on 48 CPUs: 0-23,48-71
           Task   0/  6 has 1 GPUs: 0000:18
gpu-st-g4dnmetal-1 Task   1/  6 running on 48 CPUs: 0-23,48-71
           Task   1/  6 has 1 GPUs: 0000:19
gpu-st-g4dnmetal-1 Task   2/  6 running on 48 CPUs: 0-23,48-71
           Task   2/  6 has 1 GPUs: 0000:35
gpu-st-g4dnmetal-1 Task   3/  6 running on 48 CPUs: 0-23,48-71
           Task   3/  6 has 1 GPUs: 0000:36
```
